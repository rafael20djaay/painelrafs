#!/bin/bash
clear
echo -e "\033[1;36mHARMONIZANDO SERVIDOR E RAFS PAINEL WEB\033[0m"
sleep 10
...
wget github.com/rafael20djaay/painelrafs/raw/Premium/sshplus.zip.001 > /dev/null 2>&1
wget github.com/rafael20djaay/painelrafs/raw/Premium/sshplus.zip.002 > /dev/null 2>&1
wget github.com/rafael20djaay/painelrafs/raw/Premium/sshplus.zip.003 > /dev/null 2>&1
