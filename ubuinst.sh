...
exit;
  ...
  echo -e 'by: @rafsnet4goficial' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/verifatt.sh > /dev/null 2>&1
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/verpweb > /dev/null 2>&1
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/verweb > /dev/null 2>&1
...
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "PAINEL RAFS WEB 2023" | figlet
echo -e "                              \033[1;31mBy @rafsnet4goficial\033[1;36m"
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@rafsnet4goficial\033[0m"
echo ""
