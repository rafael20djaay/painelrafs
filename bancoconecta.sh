...
wget https://github.com/rafael20djaay/painelrafs/raw/Premium/conectabd.sql > /dev/null 2>&1
cd || exit
clear
echo ""
echo -e "\033[1;33mADICIONAR BANCO DE DADOS CONECTA AO PAINEL RAFS WEB\033[0m" 
echo ""
...
echo -e "\n\033[1;31mSEU RAFS PAINEL WEB NÃO É COMPATÍVEL!\033[0m"
echo ""
sleep 3
echo -e "\033[1;31mRETORNANDO...\033[0m"
sleep 3
